...
export default function VoiceNoteModal({
  ...
  const [category, setCategory] = useState<"clinical" | "lab" | "procedure">(
    "clinical"
  );
  ...
  useEffect(() => {
    if (isOpen) setShowAnnouncement(true);
  }, [isOpen]);
  ...
  const generateAISummary = async () => {
    ...
    const aiSummary = `AI-generated summary for clinical note: ${transcript.substring(
      0,
      100
    )}... 
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          {transcript && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-blue-800 text-sm">
                Based on your input, consider documenting: vital signs, symptom
                duration, physical examination findings, and recommended
                investigations.
              </p>
            </div>
          )}
        ...
        {showAnnouncement && (
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm mx-auto text-center border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                🚧 Feature In Progress
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                This voice recording feature is still under development. Please
                check back soon.
              </p>
              <Button
                variant="outline"
